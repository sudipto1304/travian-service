...
import com.travian.account.service.AccountInfoService;
...
public class AccountInfoController {
	...
	public ResponseEntity<AccountInfoResponse> registerUser(@RequestBody AccountInfoRequest request, HttpServletRequest servletRequest, @RequestHeader HttpHeaders headers) throws IOException {
